...
air.SourceViewer.getDefault = function() {
	...
	function _SourceViewer() {
		...
		var TEXT_EXTENSIONS         	= ['txt', 'xml', 'mxml', 'htm', 'html',
		                                	...
		                                	'config', 'ini', 'bat', 'readme', 'md']; // Modificación Foog.Software. Imcluimos extensión: 'md' (Markdown)
		...
		var ADOBE_TOKEN				   = ''; // Modificación Foog.Software. En origen: 'ADOBE'
		var COPYRIGHT_TOKEN			   = '';  // Modificación Foog.Software. En origen: '&copy;'
		var AIR_TOKEN				   = '';   // Modificación Foog.Software. En origen: 'AIR'
		var TRADEMARK_TOKEN			   = ''; // Modificación Foog.Software. En origen: '&trade;'
		var APP_LEGAL_NAME             = '' //Modificación Foog.Software. En origen: 'HTML View Source Framework'
		var APP_VERSION_MAJOR_MINOR	   = ''; // Modificación Foog.Software. En origen: '1.5'.
		var TREE_DESCRIPTION_MESSAGE   = 'Selecciona un archivo en el árbol '+ //Modificación Foog.Software. En origen: 'Select a source file in the tree to' 
			                             'para ver su contenido en el panel:'; // Modificación Foog.Software. En origen: 'see its content in the right pane:'
		var COPYRIGHT_MESSAGE          = '(&#596;) 2004 - ' + fechaSistema.aaaa + ' Foog.Software'; // Modificación Foog.Software. En origen: '' (vacío)
		...
		function UIBuilder (oDomProvider) {
			...
			this.updateTitle = function(file) {
				...
				oDocument.title = 'CDOCS : VISOR DE CÓDIGO FUENTE - ' + relPath; // Modificación Foog.Software. En origen: APP_LEGAL_NAME + " - ". 
			}
			...
			function hookItemsVisualFeedback() {
				...
				var hoverCb = function(event) {
					...
					cssProvider.setStyle(el, 'background-color', '#606060'); // Modificación Foog.Software. En origen: '#606060' es 'darkNeutral'
				};
		...
		*/
		...
		CSSProvider.colorSchemes = {
			'professionalBlue' : {
				absLight			:	'#ffffff',
				absDark				:	'#000000', 
				lightNeutral		:	'#E0E0E0', // Modificación Foog.Software. En origen: "#d3dcf2"
				darkNeutral			:	'#E0E0E0', // Modificación Foog.Software. En origen: "#9197a6"
				colorMain			:	'#909090', // Modificación Foog.Software. En origen: "#7690cf"
				lighterColorAccent	:	'#505050', // Modificación Foog.Software. En origen: "#48577d"
			...
			'nightScape' : {
				...
				absDark				:	'#000000',
				lightNeutral		:	'#4F4F4F',
				darkNeutral			:	'#E0E0E0', // Modificación Foog.Software. En origen: '#696969'
				colorMain			:	'#757575',
		...
		CSSProvider.cssContent = '\
			...
			.copyrightText {\
				color: #666666; /* Modificación Foog.Software. En origen: lightNeutral */\
				font-family: arial, verdana, sans_;\
				font-size: 80%;\
				font-weight: bold;\
				text-align: right;\
